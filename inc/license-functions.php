...
if ( ! class_exists( 'Wp_License_Manager_Client' ) ) {
    ...
    class Wp_License_Manager_Client {
        ...
        /**
         * Creates the settings items for entering license information (license key).
         *
         * NOTE:
         ...
         */
        public function render_verified_license() {
            ...
            if ( !$options['license_key'] ) {
                ...
                echo '<span style="color: red; font-weight: bold">Please, insert your license in License Setting Tab</span>';
            } else {

                $info = $this->get_license_info();
                if($info['success'])
                    echo '<span style="color: green; font-weight: bold">Your license is now verified and active</span>';
                else
                    echo '<span style="color: red; font-weight: bold">'.$info['message'].'</span>';
        ...
        public function render_licenses_menu() {
            ...
            <div class="wrap">
                ...
                <form action='options.php' method='post'>
                    ...
                    <?php $this->render_verified_license(); //if ( $active_tab == '' ): ?>
                    <?php
        ...
        public function show_admin_notices() {
            if ( ! $this->get_license_key() ) {
                $msg = __( 'Please enter your license key to enable updates to %s.', $this->text_domain );
                    ...
                    <div id="setting-error-settings_updated" class="notice notice-success settings-error is-dismissible"> 
                        ...
                        <p>
                            <a href="<?php echo admin_url( 'options-general.php?page=' . $this->get_settings_page_slug() ); ?>">
                                <strong><?php _e( 'Complete the setup now.', $this->text_domain ); ?></strong>
                            </a>
                        </p>
        ...
        public function is_update_available() {
            ...
            if($package_info['success']) {
                ...
                if ( version_compare( $package_info['version'], $this->get_local_version(), '>' ) ) {
         ...
         */
        private function call_api( $path, $params ) {
